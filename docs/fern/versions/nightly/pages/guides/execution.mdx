...
`SlurmExecutor` supports defining dependencies between [jobs](/guides/management#adding-tasks), allowing you to create workflows where jobs run in a specific order. Additionally, you can specify the `dependency_type` parameter:
