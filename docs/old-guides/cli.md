---
title: "NeMo Run CLI Guide"
description: "Comprehensive guide to using the NeMo Run command-line interface for configuring and executing ML experiments"
categories: ["cli", "guides"]
tags: ["nemo-run", "cli", "command-line", "configuration", "executors", "type-safe"]
...
(old-guides-cli-comparison)=

### Comparison to Other CLI Solutions

(old-guides-cli-vs-argparse)=
...
(old-guides-cli-code-example-comparison)=

#### Code Example Comparison

:::{dropdown} CLI Framework Comparison
:icon: code-square
...
(old-guides-cli-feature-comparison)=
...
(old-guides-cli-getting-started)=

## 3. Getting Started

(old-guides-cli-basic-entrypoint)=
...
(old-guides-cli-error-correction)=
...
(old-guides-cli-advanced-configuration)=

## 4. Advanced Configuration

(old-guides-cli-nested-configurations)=
...
(old-guides-cli-configuration-files)=
...
(old-guides-cli-exporting-configurations)=
...
(old-guides-cli-slurm-executor)=

### Slurm Executor

Define and register a Slurm executor:

:::{dropdown} Slurm Executor Configuration
:icon: code-square
...
(old-guides-cli-advanced-features)=

## 6. Advanced CLI Features

(old-guides-cli-dry-runs-help)=
...
Use `--help` to view detailed CLI usage information, including registered factory functions for each argument:

```bash
python task.py --help
```

:::{dropdown} Help Output Example
:icon: code-square
