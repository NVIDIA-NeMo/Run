---
title: "NeMo Run Management Guide"
description: "Comprehensive guide to managing NeMo Run experiments, tasks, and workflows using the Experiment class"
categories: ["management", "guides"]
tags: ["nemo-run", "management", "experiments", "tasks", "workflows", "tracking"]
...
(old-guides-check-experiment-status)=
...
(old-guides-review-experiment-output)=
...
:::{dropdown} Experiment Inspection Example
:icon: code-square
...
Refer to [this notebook](../../../examples/hello-world/hello_experiments.ipynb) for more details and a playable experience.
